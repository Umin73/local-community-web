...
export default function SignUp() {
  ...
  const [username, setusername] = useState("");  // 이름 상태 값
  const [nickname, setnickname] = useState("");  // 닉네임 상태 값
  ...
  return (
      <div className="signupPage">
        ...
        <div className="signup_contentWrap">
          ...
          <div className="signup_inputWrap">
            <input type="text" className="input" value={username} onChange={(e) => setusername(e.target.value)} /> {/* 이름 입력 */}
          </div>
          <div className="signup_inputTitle">닉네임</div>
          <div className="signup_inputWrap">
            <input type="text" className="input" value={nickname} onChange={(e) => setnickname(e.target.value)} /> {/* 닉네임 입력 */}
          </div>
